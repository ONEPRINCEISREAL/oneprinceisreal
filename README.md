...
* **My Philosophy:** If you have to do it twice, automate it. I thrive on the challenge of building CI/CD pipelines that bridge the gap between code and production.
...
![CyberSecurity](https://img.shields.io/badge/Cybersecurity-Google%20Certified-blue?style=for-the-badge&logo=google)
...
| :--- | :--- | :--- |
| **AWS-EKS Integration** | Deploying Kubernetes services using Helm charts with Grafana monitoring. | `EKS` `Helm` `Grafana` |
| **Infrastructure as Code** | Automated provisioning of VPCs and EC2 instances using Terraform. | `Terraform` `AWS` |
| **CI/CD Pipeline** | End-to-end automation from Git commit to Docker deployment. | `Jenkins` `Docker` `Git` |
